    ...
    <div className="container mx-auto my-12 px-4">
      <div className="flex flex-col md:flex-row items-center bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Over 33 Years of Real Estate Success</h2>
      ...
      <div className="flex flex-col md:flex-row items-center bg-white shadow-lg rounded-lg overflow-hidden">
         ...
         <div className="w-full md:w-1/2 p-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">We Want To Create An Unforgettable Experience For You...</h2>
          <p className="text-gray-600 text-lg">
      ...
      <div className="flex flex-col md:flex-row items-center bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="w-full md:w-1/2">
          <img
            ...
            alt="manreadingnewspaper"
            className="object-cover w-full h-full rounded-xl"
          />
        </div>
        <div className="w-full md:w-1/2 p-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">The Hansen Partners Communications Tablet</h2>
